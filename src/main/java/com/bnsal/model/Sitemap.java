...
public final class Sitemap {
     ...
     * @see com.bnsal.model.Sitemap.SitemapType
     */
     ...
     * @see com.bnsal.SitemapParser#parseSitemap(java.io.InputStream, java.net.URL, java.util.Date)
     * @see com.bnsal.SitemapParser#parseSitemap(String, java.util.Date)
     * @see com.bnsal.SitemapParser#parseSitemap(java.net.URL, boolean, java.util.Date)
     */
